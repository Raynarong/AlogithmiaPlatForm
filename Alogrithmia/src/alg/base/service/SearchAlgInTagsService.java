...
public class SearchAlgInTagsService {
public ArrayList<Algorithm> searchAlgoInTags(String searchKeywords,String tagName){
...
//	    int port = 9312;
	    ...
	    try {
	       ...
	       for( int i=0; i<res.matches.length; i++ ){
	    	   ...
	    	   String sql = "select * from algorithm_table,algo_tag,algorithm_tags,users where algorithm_table.algorithm_id=? and algo_tag.tag_id= \'"+tagName+"' and algorithm_table.algorithm_id=algo_tag.algorithm_id and algo_tag.tag_id=algorithm_tags.tag_id and algorithm_table.user_id=users.user_id and version IS NOT NULL";
