...
//	    int port = 9312;
	    ...
	    try {
	       ...
	       for( int i=0; i<res.matches.length; i++ ){
	    	   ...
	    	   String sql = "select * from algorithm_type,algorithm_table,users where algorithm_table.algorithm_id=? and algorithm_type.type_id=algorithm_table.type_id and algorithm_type.type_id= \'"+typeName+"' and algorithm_table.user_id=users.user_id";
