...
public class AlgoTestAciton {
	...
	public void testAlgo() throws Exception
	{
		...
		String caller = (String) session.getAttribute("user_name");
		String classStr = "";
...
//		TestClient testClient = new TestClient("http://localhost:8080/AlogServer/servlet/HelloworldServlet", classStr, line);
		TestClient testClient = new TestClient(ConfigurationConstant.ALOGSERVER_URL + "/servlet/HelloworldServlet", classStr, line, caller, "在线测试算法", "web服务器");
...
//		TestClient testClient = new TestClient("http://localhost:8080/AlogServer/servlet/HelloworldServlet", classStr, line);
		TestClient testClient = new TestClient(ConfigurationConstant.ALOGSERVER_URL + "/servlet/HelloworldServlet", classStr, line,user_name, "在线测试算法","web服务器");
